...
export default function BuildLeft({ title, button, bgAndTextColor }: BuildLeftProps) {
  return (
    <div className={`w-full ${bgAndTextColor} pt-16 pb-8 px-6`}>
      ...
      <button type="button" className="mt-8 text-yellow-500 border border-yellow-500 rounded py-2 px-6 font-semibold">
        {button}
      </button>
    </div>
  );
