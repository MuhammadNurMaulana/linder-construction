...
export default function HeaderTwoPage({ title, button, paragraph, children, bgImage }: HeaderProps) {
  return (
    <div className="flex flex-col lg:flex-row w-full">
      <div className={`w-full lg:w-[60%] h-screen object-cover bg-center ${bgImage} flex justify-center items-center text-white`}>
        <div className="w-4/5 flex flex-col gap-4">
          ...
          <button type="button" className="bg-yellow-500 text-white font-semibold max-w-max py-3 px-6 rounded-md">
            {button}
          </button>
        </div>
      </div>
