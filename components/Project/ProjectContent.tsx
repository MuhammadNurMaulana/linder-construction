...
export default function ProjectContent() {
  return (
    <section className="w-full md:w-4/5 mx-auto">
      <Image src={"/images/component5.jpg"} alt="project" width={1080} height={1080} className="rounded object-cover w-full h-[50vh] object-center" />

      <div className="py-8 flex flex-col md:flex-row gap-8">
        <Image src={"/images/component7.jpg"} alt="project" width={600} height={600} className="rounded mx-auto object-cover w-4/5 md:w-[40%] h-[35vh]" />
