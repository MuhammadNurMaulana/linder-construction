...
export default function ProjectContent() {
  return (
    <section className="w-full md:w-4/5 mx-auto">
      <Image src={"/images/home1.jpg"} alt="project" width={1080} height={500} className="rounded object-cover w-full h-[50vh] object-center" />

      <div className="py-8 flex flex-col md:flex-row gap-8">
        <Image src={"/images/project2.jpg"} alt="project" width={1080} height={500} className="rounded mx-auto object-cover w-4/5 md:w-[40%] h-[35vh]" />
