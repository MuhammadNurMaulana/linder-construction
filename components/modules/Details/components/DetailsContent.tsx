...
export default function DetailsContent({ src, alt, blog1, blog2, blog3, blog4, title, date }: Props) {
  return (
    <div className="w-4/5 mx-auto text-justify">
      ...
      <Image src={src} alt={alt} width={1080} height={1080} className="w-full h-[35vh] object-cover object-center rounded" priority={true} />
