...
export default function MainHeader() {
  return (
    <section className="bg-home1 bg-cover bg-center">
      <HeaderTwoPage title="Construction" paragraph="Lorem ipsum dolor sit amet consectetur adipisicing elit. Cumque eaque beatae inventore quas ad nam eos iste molestias delectus architecto!" button="View Our Work">
