import OurService from "@/common/elements/OurService";
...
export default function Header() {
  return (
    <section className="bg-home1 bg-cover bg-center">
      <PageHeader title="Construction" paragraph="Lorem ipsum dolor sit amet consectetur adipisicing elit. Cumque eaque beatae inventore quas ad nam eos iste molestias delectus architecto!" button="View Our Work" to="/about">
