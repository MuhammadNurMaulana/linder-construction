...
export default function ProjectHeader() {
  return (
    <section className="bg-home2 bg-cover bg-center">
      <HeaderTwoPage title="Monarch HQ Project" paragraph="Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor, ipsum. Vitae deserunt placeat quas dignissimos! Lorem ipsum dolor sit amet." btnCls="hidden" to="/">
